import { Search, Bell, ChevronDown, RefreshCw, Filter, Sun, Moon } from 'lucide-react';
      ...
      <div className="flex items-center gap-2 ml-auto">
        ...
        <button
          ...
          onMouseEnter={(e) => {
            ...
            (e.currentTarget as HTMLButtonElement).style.backgroundColor = 'var(--dash-hover)';
          }}
          onMouseLeave={(e) => {
            (e.currentTarget as HTMLButtonElement).style.color = 'var(--dash-text-2)';
            (e.currentTarget as HTMLButtonElement).style.backgroundColor = 'var(--dash-input-bg)';
          }}
        >
          {isDark ? (
        ...
        <button
          ...
          onMouseEnter={(e) => ((e.currentTarget as HTMLButtonElement).style.backgroundColor = 'var(--dash-input-bg)')}
        ...
        >
          ...
          <div className="text-left">
            <div style={{ fontSize: '12px', color: 'var(--dash-text)', lineHeight: 1.2 }}>김영철 PM</div>
            <div style={{ fontSize: '10px', color: 'var(--dash-text-4)', lineHeight: 1.2 }}>관리자</div>
          </div>
